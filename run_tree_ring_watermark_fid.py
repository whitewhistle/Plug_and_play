...
def main(args):
    ...
    # ground-truth patch
    gt_patch = get_watermarking_pattern(pipe, args, device,args.w_pattern)
    ...
    for i in tqdm(range(args.start, args.end)):
        ...
        # inject watermark            
        init_latents_w = inject_watermark(init_latents_w, watermarking_mask,gt_patch, args,args.w_injection)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', default='f')
