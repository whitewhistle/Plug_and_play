...
def main(args):
    ...
    if args.with_tracking:
        ...
        table = wandb.Table(columns=['gen_no_w', 'gen_w','gen_z','gen_ra','gen_sr','gen_sra','gen_sz','prompt'])
    ...
    for i in tqdm(range(args.start, args.end)):
        ...
        if (i < args.max_num_log_image):
            ...
            'gen_no_w', 'gen_w','gen_z','gen_ra','gen_sr','gen_sra','gen_sz','prompt'
            table.add_data(wandb.Image(orig_image_no_w), wandb.Image(orig_image_w_ring),wandb.Image(orig_image_w_zero),wandb.Image(orig_image_w_rand),wandb.Image(orig_image_w_sring),wandb.Image(orig_image_w_srand),wandb.Image(orig_image_w_szero), current_prompt)
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', default=f"run_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}")
